import { MccRiskMap, NormalizationConstants, TransactionRequest } from "../types/transaction-type.js";
...
function normalizeDateTimeUTC(isoString: string): { hour: number, weekday: number } {
    ...
    // hora UTC normalizada: 0h = 0.0, 23h = 1.0
    const hour = date.getUTCHours() / 23;

    // dia da semana: segunda = 0.0, domingo = 1.0
...
export function toVector(
    ...
    // chama uma única vez para evitar criar dois objetos Date
